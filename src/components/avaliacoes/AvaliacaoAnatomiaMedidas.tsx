...
const PERIMETRIA: MedidaField[] = [
  ...
  { name: "peito", label: "Peito", id: "chest", view: "frente", ax: 210, ay: 108, side: "right" },
  ...
  return (
    <>
      ...
      <AnatomiaMedidasSection
        ...
        caption="Opcional — deslize o boneco para frente e costas. Protocolo típico: tricipital, subescapular, abdominal, supra-ilíaca, coxa."
        fields={DOBRAS}
      />
    </>
  );
