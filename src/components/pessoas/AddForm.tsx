...
import type { PessoaFormCatalogs } from "components/pessoas/EditForm";
...
export default function AddForm({ formRef, catalogs, fotoPreview, onPickFoto, onFotoDrop }: AddFormProps) {
    ...
    <Fragment>
      ...
      <Box sx={pessoaSectionSx}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          IP e coordenadas são opcionais. O mapa usa visão do Brasil até você informar latitude e longitude.
        </Typography>
        ...
        <GoogleMapEmbed latitude={null} longitude={null} />
      </Box>
    </Fragment>
  );
}
